  ...
  if (onlyCurrent) {
    ...
    if (cur) {
      const rows = await db.prepare(`
        SELECT id, user_id, catalog_course_id, course_name, course_code, credit_hours, semester, difficulty, target_grade, professor_name, description, current_grade, progress, finalized_at, passed, created_at, semester_id, withdrawn
...
studentRouter.get('/courses/:id', async (req, res) => {
  ...
  const row = await db.prepare(`
    SELECT id, user_id, catalog_course_id, course_name, course_code, credit_hours, semester, difficulty, target_grade, professor_name, description, current_grade, progress, finalized_at, passed, created_at, withdrawn, semester_id
